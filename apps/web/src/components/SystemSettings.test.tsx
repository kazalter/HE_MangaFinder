...
const { config, apiMock } = vi.hoisted(() => {
  const config = {
    ...
    radar: { enabled: false, sync_interval_minutes: 120, event_sync_interval_minutes: 30, initial_backfill_days: 90, max_posts_per_sync: 100, agent_enabled: true, candidate_threshold: 0.6, auto_confirm_threshold: 0.92, ocr_enabled: true, ocr_max_posts_per_sync: 12, ocr_timeout_seconds: 30, media_cache_max_gb: 10, media_max_dimension: 1600, media_webp_quality: 80, delete_confirm_hours: 24 },
